...
import 'package:gmcmanjeri_survey/models/person.dart';
import 'package:gmcmanjeri_survey/views/questionnaire.dart';
                ...
                child: RaisedButton(
                  ...
                  onPressed: (){
...

                    {
                      ...
                      Scaffold.of(context).showSnackBar(_showSnack("One or more components above are empty."));
                    }
                  },
                ),
              )
